	...
	try {
		...
		if (forceOD || taiwanNow.getDate() === 1) {
			try {
				...
				const nextMonth = taiwanNow.getMonth() + 2; // +1 for next month, +1 because 0-based
